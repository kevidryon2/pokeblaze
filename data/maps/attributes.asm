...
ENDM
	...
	connection east, ValentineForest, VALENTINE_FOREST, 0
    
    map_attributes ValentineForest, VALENTINE_FOREST, $05, EAST, WEST
    connection east, Route32, ROUTE_32, -3
    connection west, GoldenrodCity, GOLDENROD_CITY, 0
    
    map_attributes JosephsHouse, JOSEPHS_HOUSE, $00, 0
	...
	connection west, ValentineForest, VALENTINE_FOREST, 3
