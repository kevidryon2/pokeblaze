...
PokemonEnduredHitText:
    text_ram wEnemyMonNickname
    text " endured"
    line "the hit thanks to"
    cont "friendship!"
    prompt

PokemonCuredItselfBurn:
    text_ram wEnemyMonNickname
    text " cured"
    line "itself of the burn"
    cont "thanks to"
    cont "friendship!"
    prompt

PokemonCuredItselfPoison:
    text_ram wEnemyMonNickname
    text " expelled"
    line "its poison thanks"
    cont "to friendship!"
    prompt

PokemonCuredItselfParalysis:
    text_ram wEnemyMonNickname
    text " broke"
    line "trough paralysis"
    cont "thanks to"
    cont "friendship!"
    prompt
    
PokemonCuredItselfFreeze:
    text_ram wEnemyMonNickname
    text " unfroze" 
    line "thanks to"
    cont "friendship!"
