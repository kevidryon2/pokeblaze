ClearScreen:
    ...
    ld hl, $9800 ;Address of start of screen RAM
.loop:
    ld a, b
    ld [hl], a
.check:
...
; entries correspond to item ids (see constants/item_constants.asm)
	...
	dw MusicBoxEffect      ; MUSICBOX
	dw RestoreHPEffect     ; FRESH_WATER
	dw RestoreHPEffect     ; SODA_POP
	dw RestoreHPEffect     ; LEMONADE
	dw XItemEffect         ; X_ATTACK
	dw PokeBallEffect      ; TIMER_BALL TIMER_BALL
...
;Use the sum of the first 3 item quantities to determine the Music ID
MusicBoxEffect:
.clearPaletteBg2:
    ld a, $81 ;modify bg2 with auto-increment
    ld [$ff68], a
    ld a, $00
...
.initMusic:
    ...
    call PlayMusic
    call ClearScreen
    ld bc, MusicBoxMessage
    ld de, $9800
    ld h, $00
    ld a, [MusicBoxMessageSize]
    ld l, a
    push bc
    call DisableLCD
    pop bc
    ...
    call EnableLCD
.calcMusicID:
    ld a, [wItems+1] ;First quantity
    ld d, a
    ld a, [wItems+3] ;Second quantity
    ld b, a
    ld a, [wItems+5] ;Third quantity
    ld c, a
    ld a, d
    ld de, $0000
    add b
...
.max_1
	...
	; FIXED: farcall overwrites a, and GetItemHeldEffect takes b anyway.
...
;Compare to 4
    ld a, [hQuotient]
    cp $4
;If A is equal or higher than 4, return 4; else, return A.
    jp nc, .returnMaj
    jp .end
.returnMaj
    ld a, $20
.end ;Multiply the catch rate by A
    ld c, a
    ld a, b
    ld [hMultiplicand], a
    ld a, c
...
QuickBallMultiplier:
    ...
    call z, .firstTurn ;Is it the first turn?
    ret
.firstTurn
    sla b ;Multiply by 2
    jp UltraBallMultiplier ;Multiply again by 2 and return
...
; Moon Stone's constant from Pokémon Crystal is used.
	push bc
	ld a, BANK("Evolutions and Attacks")
	call GetFarByte
	cp MOON_STONE ; MOON_STONE
	pop bc
	ret nz
